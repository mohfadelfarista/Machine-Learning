...
from sklearn.metrics import confusion_matrix, roc_curve, auc, RocCurveDisplay, ConfusionMatrixDisplay, precision_recall_curve
...
print(classification_report(y_val, y_pred_base, digits=3))
...
print("=== Tuned Model ===")
print(classification_report(y_val, y_pred_tuned, digits=3))
